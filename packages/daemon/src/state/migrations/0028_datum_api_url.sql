...
-- When set, the daemon polls Datum's HTTP stats/dashboard port each
-- tick to get Datum's view of connection count and hashrate.
-- Integration is purely informational - the control loop does not
-- depend on it.
